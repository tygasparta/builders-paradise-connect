...
export const WAREHOUSE_TYPES = [
  ...
  { value: "virtual_employee", label: "Employee (virtual)", hint: "Stock issued to staff on requisition" },
...
export const warehouseSchema = z.object({
  ...
  type: z.enum(["main", "shop_floor", "branch", "virtual_employee", "damaged", "returns", "in_transit"]),
